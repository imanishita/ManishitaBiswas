...
const StatusBadge = memo(() => (
  ...
  >
    ...
    <span className="relative flex h-2.5 w-2.5">
      <span className="absolute inline-flex h-full w-full rounded-full bg-indigo-500 opacity-70 animate-ping"></span>
    ...
    <span className="text-sm text-gray-200">
      Open for{" "}
      <span className="text-indigo-500 font-medium">freelance</span>{" "}
      &{" "}
      <span className="text-indigo-500 font-medium">full-time</span>{" "}
      opportunities
    </span>
  </div>
));
...
const WORDS = ["Technology", "&","Feline Enthusiast"];
...
const Home = () => {
  ...
  const lottieOptions = {
    src: "https://lottie.host/68627364-ea5f-4005-a37b-417040461c97/hK4LfFQ5Az.lottie",
    loop: true,
    autoplay: true,
    rendererSettings: {
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Innovative web developer creating functional, user-friendly sites.
                </p>
