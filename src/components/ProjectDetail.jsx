        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 py-8 md:py-16">
          <div className="flex items-center space-x-2 md:space-x-4 mb-8 md:mb-12 animate-fadeIn">
            ...
            <div className="flex items-center space-x-1 md:space-x-2 text-sm md:text-base text-white/50">
              ...
              <span className="text-white/90 truncate max-w-[200px] md:max-w-none">{project.Title}</span>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 md:gap-16">
            <div className="space-y-6 md:space-y-10 animate-slideInLeft">
              <div className="space-y-4 md:space-y-6">
                <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold bg-gradient-to-r from-blue-200 via-purple-200 to-pink-200 bg-clip-text text-transparent leading-tight">
                  {project.Title}
                </h1>
              ...
              <div className="space-y-4 md:space-y-6">
                ...
                {project.TechStack.length > 0 ? (
                  ...
                  <p className="text-sm md:text-base text-gray-400 opacity-50">No technologies specified.</p>
                )}
              </div>
            </div>

            <div className="space-y-6 md:space-y-10 animate-slideInRight">
              <div className="relative rounded-2xl overflow-hidden border border-white/10 shadow-2xl group aspect-video bg-white/5 flex items-center justify-center">
                {imageError ? (
                  <div className="text-gray-400 p-8 text-center">
                    <p>Failed to load project image</p>
                  </div>
                ) : (
                  <>
                    ...
                    <img
                      ...
                      loading="lazy"
                    />
                    <div className="absolute inset-0 border-2 border-white/0 group-hover:border-white/10 transition-colors duration-300 rounded-2xl z-10" />
                  </>
                )}
              </div>
              ...
              <div className="bg-white/[0.02] backdrop-blur-xl rounded-2xl p-6 md:p-8 border border-white/10 space-y-6 hover:border-white/20 transition-colors duration-300 group">
                ...
                {project.Features.length > 0 ? (
                  ...
                  <p className="text-gray-400 opacity-50">No features specified.</p>
                )}
              </div>
            </div>
          </div>
